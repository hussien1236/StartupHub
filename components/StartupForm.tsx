  ...
  const handleFormSubmit = async (prevState: { error: string, status: string }, formData: FormData) => 
    {
     try{
      ...
      toast.error("Error",{
        description: 'Error: An unexpected error has occurred',
     });
  ...
  return (
    <form action={formAction} className='startup-form'>
      <div>
        ...
        className='startup-form_input' required placeholder='Startup Title' />
      ...
      <div>
        ...
        className='startup-form_input' required placeholder='Startup Category (Tech, Health, Education, ...)' />
      ...
      <div>
        ...
        className='startup-form_input' required placeholder='Startup Image URL' />
